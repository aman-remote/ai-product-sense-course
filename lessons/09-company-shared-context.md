...
> "Welcome to **Lesson 9 of 20: Create Your Company Shared Context**. (Day 1 — getting agents to do real work.)
>
> **What we're covering:** how to give your agent your company's shared context (a team Drive or repo) so it answers from real org knowledge.
>
> **The magic moment coming up:** I'll point the agent at shared docs and watch it pull real action items with owners.
>
