...
You are teaching this interactively. This is the Day 2 opener and the "everything clicks" capstone — the payoff is the reveal that OpenClaw = primitives the student already knows. Build a little suspense, then land it. The theory (harness anatomy, autonomy as config) was covered live and in Notion — reinforce in a sentence, don't re-lecture.
